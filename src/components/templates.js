...
const Templates = {
     ...
     */
    formInput(id, label, type = 'text', required = false, placeholder = '', value = '') {
      return `
     ...
     */
    formGroupWithValidation(id, label, type = 'text', required = false, placeholder = '', value = '', error = '') {
      const inputClass = error ? 'form-control is-invalid' : 'form-control';
      const errorHtml = error ? `<div class="invalid-feedback">${error}</div>` : '';
     ...
     */
    textarea(id, label, required = false, placeholder = '', value = '', rows = 4) {
      return `
        <div class="form-group">
          <label for="${id}" class="form-label">${label}</label>
          <textarea 
        ...
        <div class="book-details-container">
          ...
          <div class="book-info">
            ...
            <div id="book-details-view">
              <p><strong>Author:</strong> <span id="book-author">${book.author}</span></p>
              <p><strong>Category:</strong> <span id="book-category">${book.category}</span></p>
              <p><strong>Description:</strong> <span id="book-description">${book.description}</span></p>
            ...
            <div id="book-details-edit" style="display:none;">
              <label>Title:</label>
              <input type="text" id="edit-title" class="form-control" value="${book.title}">
              
              <label>Author:</label>
              <input type="text" id="edit-author" class="form-control" value="${book.author}">
              
              <label>Category:</label>
              <input type="text" id="edit-category" class="form-control" value="${book.category}">
